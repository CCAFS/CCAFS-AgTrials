<div> 
    <script language="javascript">
        ...
        function callprogressData(vValor,vFila,vTotal){
            document.getElementById("getprogressData").innerHTML = vValor;
            document.getElementById("getprogressrecordData").innerHTML = vFila+'/'+vTotal+' Records';
            document.getElementById("getProgressBarFillData").innerHTML = '<div class="ProgressBarFill" style="width: '+vValor+'%;"></div>';
        }
        ...
        <td>
            <div class="sf_admin_edit ui-widget ui-widget-content ui-corner-all" id="sf_admin_container">
                <div class="fg-toolbar ui-widget-header ui-corner-all">
                    <h1>Batch Upload Trials (Processing)</h1>
                </div>
                <table class="Forma">
                    <tr class="TRTDCenter">
                        <td class="TRTDCenter"><font color='#0000A0' face='Verdana' size='2'><B>*** Information Processing Trial Template File ***</B></font></td>
                    </tr>
                    <tr><td></td></tr>
                    <tr class="TRTDCenter">
                        <td class="TRTDCenter">
                    ...
                    <tr><td>&nbsp;</td></tr>
                    <tr class="TRTDCenter">
                        <td class="TRTDCenter"><font color='#0000A0' face='Verdana' size='2'><B>*** Information Processing Trial Data Template File ***</B></font></td>
                    </tr>
                    <tr><td></td></tr>
                    <tr class="TRTDCenter">
                        <td class="TRTDCenter">
                            <div class="ProgressBar TRTDCenter">
                                <div class="ProgressBarText TRTDCenter">
                                    <b><span class="TRTDCenter" id="getprogressData"></span>&nbsp;% Completed</b></br>
                                    <span class="TRTDCenter" id="getprogressrecordData"></span>
                                </div>
                                <div class="TRTDCenter" id="getProgressBarFillData"></div>
                            </div>
                        </td>
                    </tr>
                    <?php } ?>
                    ...
                    <tr class="TRTDCenter">
                        <td class="TRTDCenter">
                            <button class="Buttons" onclick="location.href='/batchupload'" title='Close' name='Close' type='button'><img src='/images/delete.png'> <b>Close</b></button>
                        </td>
                    </tr>
                    <tr><td>&ensp;</td></tr>
                </table>
