    ...
    <script>
        $(document).ready(function() {
            $('#uploadsubmit').click(function() {
                var filelocation = $('#filelocation').attr('value');
                if(filelocation == ''){
                    jAlert('error', 'Select Location Template File','Invalid File', null);
                }else{
                    var fragmento = filelocation.split('.');
                    var extension = fragmento[1];
                    if(!((extension == 'XLS') || (extension == 'xls'))){
                        $('#filelocation').attr('value','');
                        $("#filelocation").val('');
                        jAlert('error', 'Permitted file (.XLS)','Invalid File', null);
                    }else{
                        $('#div_loading').show();
                        $('#batchuploadlocations').submit();
                    }
                }
            });
        });
    ...
    <div class="sf_admin_edit ui-widget ui-widget-content ui-corner-all" id="sf_admin_container">
        ...
        <div id="sf_admin_content">
            <div class="sf_admin_form">
                <form id="batchuploadlocations" name="batchuploadlocations" action="<?php echo url_for('@batchuploadlocation'); ?>" enctype="multipart/form-data" method="post">
                    <table align="center">
                        </br>
                        <tr>
                            <td colspan="3">
                                <fieldset>
                                    ...
                                    <span><?php echo image_tag('attention-icon.png'); ?><?php echo link_to('Template File', "@downloadestruturelocation"); ?> must have <b>.xls</b> extension and must be smaller than <b>5 MB</b> maximum size</span></br>
                        ...
                        <tr>
                            <td colspan="3">
                                <fieldset>
                                    ...
                                    <?php echo link_to(image_tag('excel-icon.png') . ' Location Template File', "@downloadestruturelocation") . "<br>"; ?>
                                </fieldset>
                            </td>
                        </tr>
                        <tr align="center"><td colspan="3" align="center">&ensp;</td></tr>
                        <tr>
                            <td width="35%"><b>Location Template File:</b></td>
                            <td width="65%"><input type="file" name="filelocation" id="filelocation"></td>
                        </tr>
                        <tr align="center"><td colspan="3" align="center">&ensp;</td></tr>
                        <tr align="center">
