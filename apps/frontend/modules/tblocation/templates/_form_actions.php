...
<?php if ($form->isNew()): ?>
  ...
  <a href="/batchuploadlocation?pop=1&amp;KeepThis=true&amp;TB_iframe=true&amp;width=800&amp;height=500" class="thickbox fg-button-mini fg-button ui-state-default fg-button-icon-left"><img src="/images/upload-file-icon.png">Batch upload</a>
