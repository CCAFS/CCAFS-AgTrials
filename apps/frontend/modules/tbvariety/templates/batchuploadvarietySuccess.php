    ...
    <script>
        $(document).ready(function() {
            $('#uploadsubmit').click(function() {
                ...
                if(filevariety == ''){
                    jAlert('error', 'Select Variety Template File','Invalid File', null);
                }else{
    ...
    <div class="sf_admin_edit ui-widget ui-widget-content ui-corner-all" id="sf_admin_container">
        ...
        <div id="sf_admin_content">
            <div class="sf_admin_form">
                <form id="batchuploadvarietys" name="batchuploadvarietys" action="<?php echo url_for('@batchuploadvariety'); ?>" enctype="multipart/form-data" method="post">
                    <table align="center">
                        </br>
                        <tr>
                            <td colspan="3">
                                <fieldset>
                                    ...
                                    <span><?php echo image_tag('attention-icon.png'); ?><?php echo link_to('Template File', "@downloadestruturevariety"); ?> must have <b>.xls</b> extension and must be smaller than <b>5 MB</b> maximum size</span></br>
                        ...
                        <tr>
                            <td colspan="3">
                                <fieldset>
                                    ...
                                    <?php echo link_to(image_tag('excel-icon.png') . ' Variety Template File', "@downloadestruturevariety") . "<br>"; ?>
                                </fieldset>
                            </td>
                        </tr>
                        <tr align="center"><td colspan="3" align="center">&ensp;</td></tr>
                        <tr>
                            <td width="35%"><b>Variety Template File:</b></td>
