...
<div class="sf_admin_form">
    <?php echo form_tag_for($form, '@tbtrial') ?>

    <div class="sf_admin_actions_block ui-widget">
        <?php include_partial('tbtrial/form_actions', array('tbtrial' => $tbtrial, 'form' => $form, 'configuration' => $configuration, 'helper' => $helper)) ?>
    </div>
    ...
    ?>
        ...
        <?php endif ?>
        <?php foreach ($configuration->getFormFields($form, $form->isNew() ? 'new' : 'edit') as $fieldset => $fields): ?>
        <?php include_partial('tbtrial/form_fieldset', array('tbtrial' => $tbtrial, 'form' => $form, 'fields' => $fields, 'fieldset' => $fieldset)) ?>
        <?php endforeach; ?>
                    </div>
