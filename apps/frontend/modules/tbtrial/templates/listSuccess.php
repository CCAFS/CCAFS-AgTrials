...
if ($id_country != '')
    $id_country_Clear_Display = "visible";
if ($id_trialsite != '')
        ...
        <?php echo image_tag('loading.gif'); ?>
            ...
            <div id="tbtrial_filter">
                <form id="tbtriallist" name="tbtriallist" action="<?php echo url_for('@list'); ?>" enctype="multipart/form-data" method="post">
                    <table align="center">
                        ...
                        <tr>
                            ...
                            <td><?php echo select_from_table_trial("id_country_list", "tb_country", "id_country", "cntname", null, $id_country); ?>&ensp;<span id="Div_id_country_list" style="display:none;"><?php echo image_tag('loading4.gif'); ?></span><span id="Div_id_country_list_Clear" style="display:<?php echo $id_country_Clear_Display; ?>;"><a href="#" title="Clear value"><?php echo image_tag('clear-icon.png'); ?>Reset</a></span></td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            ...
                            <td>
                        <?php echo thickbox_iframe("<textarea id=\"varieties\" name=\"varieties\" readonly=\"readonly\" cols=\"58\" rows=\"2\" placeholder=\"Click to select Varieties/Race\">$varieties</textarea>" . image_tag('list-icon.png'), '@varieties', array('pop' => '1')) ?>
                ...
                <tr>
                    ...
                    <td>
                        <?php echo thickbox_iframe("<textarea id=\"variablesmeasured\" name=\"variablesmeasured\" readonly=\"readonly\" cols=\"58\" rows=\"2\" placeholder=\"Click to select Variables measured\">$variablesmeasured</textarea>" . image_tag('list-icon.png'), '@variablesmeasured', array('pop' => '1')) ?>
