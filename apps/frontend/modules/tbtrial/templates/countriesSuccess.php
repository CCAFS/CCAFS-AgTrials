...
$session_countries_id = $user->getAttribute('countries_id');
$session_countries_name = $user->getAttribute('countries_name');
$selected = "";
if (isset($session_countries_id)) {
    foreach ($session_countries_id as $key => $id_countries) {
        $selected .= '{id:' . intval($id_countries) . ',title:"' . htmlspecialchars(str_replace(',', '-', $session_countries_name[$key]), ENT_QUOTES, 'UTF-8') . '"},';
    }
}
?>
<script type="text/javascript">
$(function(){
    $('#countries_id').autocompletecountries({
...
<div class="sf_admin_edit ui-widget ui-widget-content ui-corner-all" id="sf_admin_container">
    ...
    <div id="sf_admin_content">
        <div class="sf_admin_form">
            <br>
            <form id="countries" name="countries" action="<?php echo url_for('@savecountries'); ?>" enctype="multipart/form-data" method="post">
                <table align="center">
                    <tr align="center">
                        <td align="center">
                            <fieldset align="center">
                                <div>
                                    <input id="countries_id" name="countries_id" type="text" size="50" />
                                </div>
                                <br>
                            </fieldset>
                        </td>
