    ...
    <script>
        $(document).ready(function() {
            $('#uploadsubmit').click(function() {
                ...
                var filetrialsite = $('#filetrialsite').attr('value');
                if(id_country == ''){
                    jAlert('error', 'Select Country','Incomplete Information', null);
                }else if(filetrialsite == ''){
                    jAlert('error', 'Select Check Trial Site Template File','Invalid File', null);
                }else{
                    var fragmento = filetrialsite.split('.');
                    var extension = fragmento[1];
                    if(!((extension == 'XLS') || (extension == 'xls'))){
                        $('#filetrialsite').attr('value','');
                        $("#filetrialsite").val('');
                        jAlert('error', 'Permitted file (.XLS)','Invalid File', null);
                    }else{
                        $('#div_loading').show();
                        $('#checktrialsitebatch').submit();
                    }
                }
            });
        });
    ...
    <div class="sf_admin_edit ui-widget ui-widget-content ui-corner-all" id="sf_admin_container">
        ...
        <div id="sf_admin_content">
            <div class="sf_admin_form">
                <form id="checktrialsitebatch" name="checktrialsitebatch" action="<?php echo url_for('@checktrialsitebatch'); ?>" enctype="multipart/form-data" method="post">
                    <table align="center">
                        </br>
                        <tr>
                            <td colspan="3">
                                <fieldset>
                                    ...
                                    <span><?php echo image_tag('attention-icon.png'); ?><?php echo link_to(' Check Trial Site Template File', "@downloadchecktrialsitetemplate"); ?> must have <b>.xls</b> extension and must be smaller than <b>5 MB</b> maximum size</span></br>
                        ...
                        <tr>
                            <td colspan="3">
                                <fieldset>
                                    ...
                                    <?php echo link_to(image_tag('excel-icon.png') . ' Check Trial Site Template File', "@downloadchecktrialsitetemplate") . "<br>"; ?>
                                </fieldset>
                            </td>
                        </tr>
                        <tr align="center"><td colspan="3" align="center">&ensp;</td></tr>
                        <tr>
                            ...
                            <td width="65%"><?php echo select_from_table("id_country", "TbCountry", "id_country", "cntname", null, null); ?></td>
                        </tr>
                        <tr>
                            <td width="35%"><b>Check Trial Site Template File:</b></td>
                            <td width="65%"><input type="file" name="filetrialsite" id="filetrialsite"></td>
                        </tr>
                        <tr align="center"><td colspan="3" align="center">&ensp;</td></tr>
                        <tr align="center">
