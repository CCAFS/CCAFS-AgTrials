...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en" lang="en">
    ...
    <script>
        $(document).ready(function() {
            $('#uploadsubmit').click(function() {
                ...
                if(filetrialsite == ''){
                    jAlert('error', 'Select Trial Sites Template File','Invalid File', null);
                }else{
    ...
    <div class="sf_admin_edit ui-widget ui-widget-content ui-corner-all" id="sf_admin_container">
        <div class="fg-toolbar ui-widget-header ui-corner-all">
            <h1>Batch Upload Trial Sites</h1>
        </div>
        ...
        <div id="sf_admin_content">
            <div class="sf_admin_form">
                <form id="batchuploadtrialsites" name="batchuploadtrialsites" action="<?php echo url_for('@batchuploadtrialsite'); ?>" enctype="multipart/form-data" method="post">
                    <table align="center">
                        </br>
                        <tr>
                            <td colspan="3">
                                <fieldset>
                                    ...
                                    <span><?php echo image_tag('attention-icon.png'); ?><?php echo link_to(' Template File', "@downloadestruturetrialsite"); ?> must have <b>.xls</b> extension and must be smaller than <b>5 MB</b> maximum size</span></br>
                        ...
                        <tr>
                            <td colspan="3">
                                <fieldset>
                                    ...
                                    <?php echo link_to(image_tag('excel-icon.png') . ' Trial Sites Template File', "@downloadestruturetrialsite") . "<br>"; ?>
                                </fieldset>
                            </td>
                        </tr>
                        <tr align="center"><td colspan="3" align="center">&ensp;</td></tr>
                        <tr>
                            <td width="40%"><b>Trial Sites Template File:</b></td>
                            <td width="60%"><input type="file" name="filetrialsite" id="filetrialsite"></td>
                        </tr>
                        <tr align="center"><td colspan="3" align="center">&ensp;</td></tr>
                        <tr align="center">
