...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en" lang="en">
    ...
    <script>
        $(document).ready(function() {
            $('#uploadsubmit').click(function() {
                var filetrialgroup = $('#filetrialgroup').attr('value');
                if(filetrialgroup == ''){
                    jAlert('error', 'Select Trial Group Template File','Invalid File', null);
                }else{
                    var fragmento = filetrialgroup.split('.');
                    var extension = fragmento[1];
                    if(!((extension == 'XLS') || (extension == 'xls'))){
                        $('#filetrialgroup').attr('value','');
                        $("#filetrialgroup").val('');
                        jAlert('error', 'Permitted file (.XLS)','Invalid File', null);
                    }else{
                        $('#div_loading').show();
                        $('#batchuploadtrialgroups').submit();
                    }
                }
            });
        });
    ...
    <div class="sf_admin_edit ui-widget ui-widget-content ui-corner-all" id="sf_admin_container">
        <div class="fg-toolbar ui-widget-header ui-corner-all">
            <h1>Batch Upload Trial Group</h1>
        </div>
        ...
        <div id="sf_admin_content">
            <div class="sf_admin_form">
                <form id="batchuploadtrialgroups" name="batchuploadtrialgroups" action="<?php echo url_for('@batchuploadtrialgroup'); ?>" enctype="multipart/form-data" method="post">
                    <table align="center">
                        </br>
                        <tr>
                            <td colspan="3">
                                <fieldset>
                                    ...
                                    <span><?php echo image_tag('attention-icon.png'); ?><?php echo link_to(' Template File', "@downloadestruturetrialgroup"); ?> must have <b>.xls</b> extension and must be smaller than <b>5 MB</b> maximum size</span></br>
                        ...
                        <tr>
                            <td colspan="3">
                                <fieldset>
                                    ...
                                    <?php echo link_to(image_tag('excel-icon.png') . ' Trial Group Template File', "@downloadestruturetrialgroup") . "<br>"; ?>
                                </fieldset>
                            </td>
                        </tr>
                        <tr align="center"><td colspan="3" align="center">&ensp;</td></tr>
                        <tr>
                            <td width="40%"><b>Trial Group Template File:</b></td>
                            <td width="60%"><input type="file" name="filetrialgroup" id="filetrialgroup"></td>
                        </tr>
                        <tr align="center"><td colspan="3" align="center">&ensp;</td></tr>
                        <tr align="center">
