...
<div class="sf_admin_edit ui-widget ui-widget-content ui-corner-all" id="sf_admin_container">
    ...
    <div id="sf_admin_content">
        <div class="sf_admin_form">
            <br>
            <form id="trialgroupcontactperson" name="trialgroupcontactperson" action="<?php echo url_for('@savetrialgroupcontactperson'); ?>" enctype="multipart/form-data" method="post">
                <table align="center">
                    <tr align="center">
                        <td align="center">
