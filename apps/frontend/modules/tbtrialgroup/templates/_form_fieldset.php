...
<div class="ui-corner-all" id="sf_fieldset_none">
    <div class="sf_admin_form_row sf_admin_text">
        <div class="label ui-helper-clearfix">
            ...
            <div class="help"><span class="ui-icon ui-icon-info floatleft"></span>The name of the lead institution carrying out the trial program</div>
        </div>
    ...
    <div class="sf_admin_form_row sf_admin_foreignkey sf_admin_text">
        ...
        <div class="sf_admin_form_row sf_admin_text">
            ...
            <div class="help"><span class="ui-icon ui-icon-info floatleft"></span>The type of trials that collectively make up this group</div>
        </div>
        <div class="label ui-state-error-text">
        ...
        <div class="sf_admin_form_row sf_admin_text">
            ...
            <div class="help"><span class="ui-icon ui-icon-info floatleft"></span>The agricultural technology objective of the group of trials</div>
        </div>
        <div class="label ui-state-error-text">
        ...
        <div class="sf_admin_form_row sf_admin_text">
            ...
            <div class="help"><span class="ui-icon ui-icon-info floatleft"></span>The scientific discipline which is most related to the trial group</div>    
        </div>
        <div class="label ui-state-error-text">
        ...
        <div class="sf_admin_form_row sf_admin_text">
            ...
            <div class="help"><span class="ui-icon ui-icon-info floatleft"></span>The title of the trial group – one or a few words signifying the trial group</div>    
        </div>
        <div class="label ui-state-error-text">
        ...
        <div class="sf_admin_form_row sf_admin_text">
            ...
            <div class="help"><span class="ui-icon ui-icon-info floatleft"></span>The year the trial program began</div>    
        </div>
        <div class="label ui-state-error-text">
        ...
        <div class="sf_admin_form_row sf_admin_text">
            ...
            <div class="help"><span class="ui-icon ui-icon-info floatleft"></span>The year the trial program ended</div>
        </div>
        <div class="label ui-state-error-text">
        ...
        <div class="sf_admin_form_row sf_admin_text">
            <div class="label ui-helper-clearfix">
            <?php echo $form['trgrtrialgrouprecorddate']->renderLabel('Trial group record date') ?>
            <div class="help"><span class="ui-icon ui-icon-info floatleft"></span>The date that this trial group is registered in AgTrials.org</div>
        </div>
        <div class="label ui-state-error-text">
            <?php echo $form['trgrtrialgrouprecorddate']->renderError() ?>
        </div>
        <?php echo $form['trgrtrialgrouprecorddate']->render() ?>
        </div>

        <div class="sf_admin_form_row sf_admin_text">
            <div class="label ui-helper-clearfix">
            <?php echo $form['trgrtrialgrouprecordstatus']->renderLabel('Trial group record status') ?>
            <div class="help"><span class="ui-icon ui-icon-info floatleft"></span>Indicates whether new data can be added (open) or whether adding new data for the group is not allowed (all others)</div>
        </div>
        <div class="label ui-state-error-text">
