...
isPlainObject:function(i){
    ...
    for(var r in i);return r===A||C.call(i,r)
    },
isEmptyObject:function(i){
    for(var r in i)return false;return true
    },
error:function(i){
    throw i;
},
...
inArray:function(i,r){
    ...
    for(var y=0,z=r.length;y<z;y++)if(r[y]===i)return y;return-1
    },
merge:function(i,r){
    var y=i.length,z=0;
...
access:function(i,r,y,z,F,I){
    var K=i.length;
    if(typeof r==="object"){
        for(var J in r)b.access(i,J,r[J],z,F,y);return i
        }
        if(y!==A){
        ...
        if(c.acceptData(a)){
            ...
            if(!(e&&!f&&typeof b==="string"&&d===A)){
                ...
                if(typeof b==="object")if(e)h[f]=
                    c.extend(h[f],b);else c.extend(h,b);
                else if(e&&!h[f])h[f]={};
...
removeData:function(a,b){
    ...
    else if(d)delete f[e];else for(var k in a)delete a[k]
        }
    },
    ...
    addClass:function(a){
        ...
        if(a&&typeof a==="string")for(var b=(a||"").split(ga),d=0,e=this.length;d<e;d++){
            ...
            if(f.nodeType===1)if(f.className){
                for(var h=" "+f.className+" ",k=f.className,l=0,n=b.length;l<n;l++)if(h.indexOf(" "+b[l]+" ")<0)k+=" "+b[l];f.className=c.trim(k)
                }else f.className=a
                }
                return this
        },
...
hasClass:function(a){
    a=" "+a+" ";
    for(var b=0,d=this.length;b<d;b++)if((" "+this[b].className+" ").replace(qa," ").indexOf(a)>-1)return true;return false
    },
val:function(a){
    if(!arguments.length){
        var b=this[0];
...
setup:function(){
    if(this.type===
        "file")return false;
    for(var a in V)c.event.add(this,a+".specialChange",V[a]);return ha.test(this.nodeName)
    },
teardown:function(){
...
c.each(["live","die"],function(a,b){
    c.fn[b]=function(d,e,f,h){
        ...
        if(typeof d===
            ...
            for(k in d)h[b](k,e,d[k],v);return this
            }
            if(c.isFunction(e)){
            f=e;
            e=A
        ...
        for(var N in n.filter)if((x=n.leftMatch[N].exec(g))!=null&&x[2]){
            ...
            if(L.substr(L.length-1)!=="\\"){
                ...
                if(x)for(var i=0;(L=t[i])!=null;i++)if(L){
                    Q=R(L,x,i,t);
                    var r=m^!!Q;
                    if(o&&Q!=null)if(r)C=true;else t[i]=false;
                    else if(r){
                        q.push(L);
                        C=true
                        }
...
relative:{
    ...
    ">":function(g,j){
        ...
        for(;p<q;p++)if(m=g[p])g[p]=o?m.parentNode:m.parentNode===j;o&&l.filter(j,g,true)
        }
    },
"":function(g,j,o){
    var m=e++,p=b,q;
...
preFilter:{
    CLASS:function(g,j,o,m,p,q){
        ...
        for(var t;(t=j[q])!=null;q++)if(t)if(p^(t.className&&(" "+t.className+" ").replace(/[\t\n]/g," ").indexOf(g)>=0))o||m.push(t);
            else if(o)j[q]=false;return false
        },
    ID:function(g){
...
filter:{
    PSEUDO:function(g,j,o,m){
        ...
        if(q)return q(g,o,j,m);
            ...
            j=j[3];
            o=0;
            for(m=j.length;o<m;o++)if(j[o]===g)return false;return true
    ...
    CHILD:function(g,j){
        ...
        switch(o){
            case "only":case "first":
                for(;m=m.previousSibling;)if(m.nodeType===1)return false;if(o===
                "first")return true;
                m=g;
            case "last":
            ...
            case "nth":
                ...
                var x=0;
                for(m=t.firstChild;m;m=m.nextSibling)if(m.nodeType===1)m.nodeIndex=++x;t.sizcache=q
                }
                m=g.nodeIndex-p;
...
if(u.documentElement.compareDocumentPosition)w=function(g,j){
    ...
    w=function(g,j){
        ...
        for(;t;){
            ...
            p=o.length;
        q=m.length;
        for(t=0;t<p&&t<q;t++)if(o[t]!==m[t])return G(o[t],m[t]);return t===p?G(g,m[t],-1):G(o[t],j,1)
        };
...
cleanData:function(a){
    for(var b,d,e=c.cache,f=c.event.special,h=c.support.deleteExpando,k=0,l;(l=a[k])!=null;k++)if(!(l.nodeName&&c.noData[l.nodeName.toLowerCase()]))if(d=l[c.expando]){
        if((b=e[d])&&b.events)for(var n in b.events)f[n]?
            c.event.remove(l,n):c.removeEvent(l,n,b.handle);if(h)delete l[c.expando];else l.removeAttribute&&l.removeAttribute(c.expando);
        delete e[d]
    }
    }
    });
...
param:function(a,b){
    ...
    if(c.isArray(a)||a.jquery)c.each(a,function(){
        ...
        });else for(var f in a)ca(f,a[f],b,e);return d.join("&").replace(rb,"+")
    }
});
c.extend({
    active:0,
